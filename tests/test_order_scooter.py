...
class TestOrderScooter:
    ...
    def test_order_scooter_button_top(self, driver, name, surname, address, phone):
        ...
        base_page.find_element_located_click(BasePageLocators.ORDER_BUTTON_TOP)
        order_scooter = OrderScooterPage(driver)
        order_scooter.fill_form(name, surname, address, phone)
        base_page.find_element_located_click(BasePageLocators.CONTINUE_BUTTON)
        assert base_page.current_url() == "https://qa-scooter.praktikum-services.ru/order"
    ...
    def test_order_scooter_button_bottom(self, driver, name, surname, address, phone):
        base_page = BasePage(driver)
        base_page.go_to_site('https://qa-scooter.praktikum-services.ru/')
        base_page.scroll_to_order_button(BasePageLocators.ORDER_BUTTON_BOTTOM)
        base_page.find_element_located_click(BasePageLocators.ORDER_BUTTON_BOTTOM)
        order_scooter = OrderScooterPage(driver)
        order_scooter.fill_form(name, surname, address, phone)
        base_page.find_element_located_click(BasePageLocators.CONTINUE_BUTTON)
        assert base_page.current_url() == "https://qa-scooter.praktikum-services.ru/order"
